#!/usr/bin/env python3
"""
Standalone SAP Diagnostic Test - Direct Import
Bypasses __init__.py to avoid numpy dependency
"""
...
# Copy minimal diagnostic code
exec(open('sap_yunus/sap_diagnostic.py').read().split('class SAPDiagnostic:')[1].split('\nif __name__')[0])
